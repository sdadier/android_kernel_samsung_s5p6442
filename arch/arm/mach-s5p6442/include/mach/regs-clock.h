...
#define S5P6442_CLK_GATE_PCLK		S5P_CLKREG(0x34)

#define S5P6442_CLK_GATE_PCLK_UART3	(1 << 4)
#define S5P6442_CLK_GATE_PCLK_UART2	(1 << 3)
#define S5P6442_CLK_GATE_PCLK_UART1	(1 << 2)
#define S5P6442_CLK_GATE_PCLK_UART0	(1 << 1)
