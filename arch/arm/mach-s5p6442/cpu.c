...
struct bus_type s5p6442_subsys = {
	.name		= "s5p6442-core",
	.dev_name 	= "s5p6442-core",
};

static struct device s5p6442_dev = {
	.bus	= &s5p6442_subsys,
};

static int __init s5p6442_core_init(void)
{
	return subsys_system_register(&s5p6442_subsys, NULL);
}
...
int __init s5p6442_init(void)
{
	...
	return device_register(&s5p6442_dev);
}
